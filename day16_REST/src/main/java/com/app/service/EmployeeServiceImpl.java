...
public class EmployeeServiceImpl implements EmployeeService {
	...
	//service is dependent on mapper for conversion of entity to dto & dto to entity 
	...
	public AuthRespDTO authenticateEmp(AuthRequestDTO request) {
		...
		AuthRespDTO authRespDTO = mapper.map(emp, AuthRespDTO.class); //1st:-source object and 2nd authrespdto class
		return authRespDTO;
		/*
